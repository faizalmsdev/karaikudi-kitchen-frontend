            ...
            <header class="bg-white ">
                <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                    ...
                    <a href="#" class="-m-1.5 p-1.5     ">
                        <span class="text-design text-gray-700">Karaikudi Kitchen</span>
                        <img class="h-8 w-auto sr-only" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600" alt="" />
                    </a>
                    </div>
                    ...
                    <div class="relative">
                        <button type="button" class="flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900" aria-expanded="false" onClick={toggleProductSection}>
                        Product
