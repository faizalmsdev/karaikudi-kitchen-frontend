...
const Contact = () => {
    return (
            ...
            <Layout activePage={"contact"}>
                <Container>
                    <div className='flex flex-col  '>
                        <h1 className="text-5xl text-center font-design font-semibold leading-snug pt-10"> Contact Us
                                  <svg
                                   viewBox="0 0 24 24"
                                   fill="currentColor"
                                   height="1em"
      ...
      <path d="M12 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm6 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zM6 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z" />
                        ...
                        <div className=' flex justify-between  py-10 h-[20rem] mb-28 '>
                            ...
                            <div className='flex flex-col justify-between'>
                                ...
                                <p className="mb-4 flex items-center justify-center md:justify-start leading-snug ">
                                    <svg
                                       ...
                                       height="1em"
                                       width="5em">
                                       <path d="M256 32C167.67 32 96 96.51 96 176c0 128 160 304 160 304s160-176 160-304c0-79.49-71.67-144-160-144zm0 224a64 64 0 1164-64 64.07 64.07 0 01-64 64z" /></svg>
