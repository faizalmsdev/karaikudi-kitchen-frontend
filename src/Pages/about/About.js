        ...
        <div>
            <Layout activePage={"about"}>
                <div className="about">
                    ...
                    <div className="container-size flex-col md:flex-row">

                        <div className="about-left md:block hidden">
                           <img src={require('../../images/about-pic.avif')} alt="" /> 
                        </div>

                        <div className="about-right w-[100%] md:w-[50%]">
                            <h4 class='leading-snug text-center text-[20px] md:text-[18px]'>
